...
const inputTitle = document.getElementById("search-title"); // zone pour taper le titre du film
const inputYear = document.getElementById("search-year"); // année du film (optionel)
